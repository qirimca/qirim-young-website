...
import { Users, Heart, Code, BookOpen, Globe, Mail, Github, ExternalLink, Handshake, DollarSign } from 'lucide-react'
        ...
        >
          ...
          <div className="space-y-8">
            {partnershipOpportunities.map((partnership, index) => (
              <motion.div
                key={index}
                className="bg-gradient-to-r from-primary-50 to-accent-50 rounded-xl p-8 border border-primary-100"
              ...
              return (
                ...
                >
                  ...
                  <div className="space-y-2 text-xs text-primary-600">
                    {way.actions.slice(0, 2).map((action, idx) => (
