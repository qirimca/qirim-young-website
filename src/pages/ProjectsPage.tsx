...
import { Database, GitBranch, BookOpen, Users, ExternalLink, Globe } from 'lucide-react'
            ...
            return (
              ...
              >
                ...
                <div className={!isEven ? 'lg:col-start-2' : ''}>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex flex-wrap gap-4">
                      ...
                      <Link
                        to="/get-involved"
                        className="inline-flex items-center gap-2 border border-primary-300 text-primary-600 hover:bg-primary-50 px-6 py-3 rounded-lg font-medium transition-colors"
                      >
                ...
                <div className={isEven ? '' : 'lg:col-start-1 lg:row-start-1'}>
                  <motion.div 
                    className="relative bg-gradient-to-br from-primary-100 to-accent-100 rounded-2xl p-8 border border-primary-200"
