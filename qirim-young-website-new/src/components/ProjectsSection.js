...
const ProjectsSection = () => {
    ...
    return (<section id="projects" className="py-24 bg-crimean-50">
      <div className="container-width section-padding">
        ...
        <div className="mb-16">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            return (<div key={project.id} className="card group hover:-translate-y-1 transition-all duration-300">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex space-x-2">
                        {project.links.demo && (<a href={project.links.demo} target="_blank" rel="noopener noreferrer" className="p-2 bg-heritage-gold text-white rounded-lg hover:bg-heritage-gold/90 transition-colors" aria-label="View demo">
                            <lucide_react_1.ExternalLink className="w-4 h-4"/>
                          </a>)}
                        {project.links.github && (<a href={project.links.github} target="_blank" rel="noopener noreferrer" className="p-2 bg-crimean-700 text-white rounded-lg hover:bg-crimean-800 transition-colors" aria-label="View source code">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.tech.map((tech, index) => (<span key={index} className="px-2 py-1 bg-crimean-100 text-crimean-700 text-xs rounded-md">
                          {tech}
                        </span>))}
                    </div>
                  </div>
