...
const DonateSection = () => {
  ...
  return (
    <section id="donate" className="py-24 bg-gradient-to-br from-heritage-gold/5 to-crimean-100/50">
            ...
            <div className="card">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <Gift className="w-6 h-6 text-heritage-gold flex-shrink-0 mt-1" />
                  <div>
                ...
                <div className="flex items-start space-x-3">
                  <Banknote className="w-6 h-6 text-heritage-gold flex-shrink-0 mt-1" />
                  <div>
                ...
                <div className="flex items-start space-x-3">
                  <Heart className="w-6 h-6 text-heritage-gold flex-shrink-0 mt-1" />
                  <div>
