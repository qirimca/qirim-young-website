...
const HeroSection = () => {
    return (<section className="hero-gradient min-h-screen flex items-center relative overflow-hidden hero-section">
          ...
          <div className="space-y-8 animate-fade-in-up">
            ...
            <div className="space-y-4">
              <h1 className="text-5xl lg:text-7xl font-bold font-crimean-head leading-tight">
                <span className="text-gradient">Qırımtatar</span>
                <br />
                <span className="text-crimean-800">Medeniıetni</span>
                <br />
                <span className="text-crimean-600">Dijital Saqlaw</span>
              </h1>
              
              <p className="text-xl text-crimean-700 max-w-2xl leading-relaxed">
                Qırımtatar dilniñ ve medeniıetniñ dijital alemi sayesinde saqlanması ve inkişafı içün çalışqan teşkilat.
                <span className="block mt-2 text-lg text-crimean-600">
                  Preserving Crimean Tatar language and culture through digital innovation.
                </span>
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#projects" className="btn-primary inline-flex items-center justify-center space-x-2 text-lg">
                <span>Loyihalarımızni Kör</span>
                <lucide_react_1.ArrowRight className="w-5 h-5"/>
              </a>
              <a href="#donate" className="btn-secondary inline-flex items-center justify-center space-x-2 text-lg">
                <span>Yardım Et</span>
              </a>
            </div>
          ...
          <div className="relative animate-fade-in">
            <div className="relative aspect-square max-w-lg mx-auto">
              ...
              <div className="absolute -top-4 -right-4 w-16 h-16 bg-white rounded-full shadow-lg flex items-center justify-center animate-fade-in animation-delay-500">
                <lucide_react_1.Globe className="w-8 h-8 text-heritage-gold"/>
              </div>
