...
function AboutPage() {
    ...
    return (<div className="min-h-screen py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Hero Section */}
        <framer_motion_1.motion.div className="text-center mb-20" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
        ...
        <framer_motion_1.motion.div className="grid lg:grid-cols-3 gap-12 mb-20" variants={staggerChildren} initial="initial" animate="animate">
          <framer_motion_1.motion.div className="text-center" variants={fadeInUp}>
            <div className="w-20 h-20 bg-gradient-to-br from-primary-500 to-primary-600 rounded-full flex items-center justify-center mx-auto mb-6">
              <lucide_react_1.Target className="w-10 h-10 text-white"/>
            </div>
          ...
          <framer_motion_1.motion.div className="text-center" variants={fadeInUp}>
            <div className="w-20 h-20 bg-gradient-to-br from-accent-400 to-accent-500 rounded-full flex items-center justify-center mx-auto mb-6">
              <lucide_react_1.Globe className="w-10 h-10 text-white"/>
            </div>
          ...
          <framer_motion_1.motion.div className="text-center" variants={fadeInUp}>
            <div className="w-20 h-20 bg-gradient-to-br from-accent-warm-400 to-accent-warm-500 rounded-full flex items-center justify-center mx-auto mb-6">
              <lucide_react_1.Award className="w-10 h-10 text-white"/>
            </div>
        ...
        <framer_motion_1.motion.div className="mb-20" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }}>
          ...
          <div className="relative">
            ...
            return (<framer_motion_1.motion.div key={index} className={`flex items-center ${isEven ? 'flex-row' : 'flex-row-reverse'}`} initial={{ opacity: 0, x: isEven ? -50 : 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.1 * index }}>
        ...
        <framer_motion_1.motion.div className="mb-20" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.5 }}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            return (<framer_motion_1.motion.div key={index} className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 * index }} whileHover={{ y: -5 }}>
        ...
        <framer_motion_1.motion.div className="mb-20" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.6 }}>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {partners.map((partner, index) => (<framer_motion_1.motion.div key={index} className="bg-gradient-to-r from-primary-50 to-accent-50 rounded-xl p-6 border border-primary-100" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6, delay: 0.1 * index }}>
