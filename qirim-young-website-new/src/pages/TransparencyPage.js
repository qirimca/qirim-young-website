...
exports.default = TransparencyPage;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <framer_motion_1.motion.div className="mb-20" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }}>
          ...
          <div className="space-y-12">
            {financialData.map((yearData, index) => (<framer_motion_1.motion.div key={yearData.year} className="bg-white rounded-xl p-8 shadow-lg border border-gray-100" initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.1 * index }}>
                <div className="flex items-center gap-3 mb-6">
                  <lucide_react_1.DollarSign className="w-8 h-8 text-primary-600"/>
                  <div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <div className="space-y-3">
                      {yearData.sources.map((source, idx) => (<div key={idx} className="flex justify-between items-center p-3 bg-primary-50 rounded-lg">
                          <div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {yearData.expenses.map((expense, idx) => (<div key={idx} className="flex justify-between items-center p-3 bg-accent-50 rounded-lg">
                          <div>
        ...
        <framer_motion_1.motion.div className="mb-20" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }}>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {governanceStructure.map((role, index) => (<framer_motion_1.motion.div key={index} className="bg-gradient-to-r from-primary-50 to-accent-50 rounded-xl p-6 border border-primary-100" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 * index }}>
                <div className="flex items-center gap-3 mb-4">
                  <lucide_react_1.Users className="w-6 h-6 text-primary-600"/>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <ul className="space-y-1">
                      {role.responsibilities.map((resp, idx) => (<li key={idx} className="flex items-start gap-2 text-text-secondary text-sm">
        ...
        <framer_motion_1.motion.div className="mb-20" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {achievements.map((achievement, index) => (<framer_motion_1.motion.div key={index} className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 text-center" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 * index }} whileHover={{ y: -5 }}>
            ...
            return (<framer_motion_1.motion.div key={index} className="bg-white rounded-xl p-6 shadow-lg border border-gray-100" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 * index }} whileHover={{ y: -5 }}>
                  <div className="flex items-start gap-4">
                    ...
                    : 'bg-yellow-100 text-yellow-800'}`}>
                      ...
                      {report.status === 'Available' && (<div className="flex gap-2">
        ...
        {/* Ethical Commitments */}
        <framer_motion_1.motion.div className="mb-20" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.6 }}>
          <h2 className="text-3xl font-bold text-text-primary mb-12 text-center font-crimean-head">
            Our Ethical Commitments
          </h2>
          
          <div className="space-y-6">
            {ethicalCommitments.map((commitment, index) => (<framer_motion_1.motion.div key={index} className="bg-gradient-to-r from-primary-50 to-accent-50 rounded-xl p-6 border border-primary-100" initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.1 * index }}>
                <div className="flex items-start gap-4">
                  <lucide_react_1.Shield className="w-6 h-6 text-primary-600 mt-1 flex-shrink-0"/>
                  <div>
        ...
        <framer_motion_1.motion.div className="text-center bg-gradient-to-r from-primary-50 to-accent-50 rounded-2xl p-12" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.7 }}>
