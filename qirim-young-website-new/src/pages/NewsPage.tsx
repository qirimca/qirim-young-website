...
import { Calendar, ExternalLink, Github, Globe, Award, Users, Database } from 'lucide-react'
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {newsItems.filter(item => item.featured).map((item) => {
          ...
          return (
            <motion.article 
              key={item.id}
              className="mb-16 bg-gradient-to-r from-primary-50 to-accent-50 rounded-2xl p-8 border border-primary-100"
        ...
        {/* Newsletter Signup */}
        <motion.div 
          className="mt-16 text-center bg-gradient-to-r from-primary-50 to-accent-50 rounded-2xl p-12"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
